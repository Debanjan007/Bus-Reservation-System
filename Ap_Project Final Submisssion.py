...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Debanjan Singha Roy", font='Arial 16 bold', fg='black').pack()
        Label(root, text="\nER No. : 211B406", font='Arial 16 bold', fg='black').pack()
        Label(root, text="\nMobile : 9475240460\n\n\n\n", font='Arial 16 bold', fg='black').pack()
        Label(root, text="Submitted to: Dr. Mahesh Kumar", font='Arial 15 bold', bg='cyan', fg='black').pack()
    ...
    def journey_detail_page(self):
                        ...
                        if len(res_bid)==0:
                            ...
                            if len(b)==0:
                                ...
                                def proceed():
                                    ...
                                    pname = Entry(root, font='Arial 12 bold', fg='black',width=15)
                                    ...
                                    Button(root, text='BOOK SEAT', bg='green', fg='black', font='Arial 12 bold',
                                           command=book_seat).grid(row=13,column=9,padx=30)
        ...
        to_place = Entry(root, font='Arial 12 bold', fg='black',width=15)
        to_place.grid(row=4, column=4, padx=50)

        Label(root, text='From', fg='black', font='Arial 12 bold').grid(row=4, column=5, padx=30)
        from_place = Entry(root, font='Arial 12 bold', fg='black',width=15)
        ...
        journey_date = Entry(root, font='Arial 12 bold', fg='black',width=15)
